...
namespace StorybrewScripts
{
    ...
    public class ByEquation
    {
        ...
        public static string drawViaEquation(DrawInstance instance, double duration, EquationFunction equation, bool renderReceptor = true, bool renderHitSounds = true)
        {
            ...
            double scrollSpeed = instance.easetime;
            double easetime = scrollSpeed;
            ...
            Parallel.ForEach(playfieldInstance.columns.Values, column =>
            {
                ...
                var hitSoundsInRange = notes.Keys.Where(hittime => hittime >= starttime && hittime - easetime <= playfieldInstance.endtime).ToList();

                if (renderHitSounds)
                    HitSound.AddHitSound(playfieldInstance, column, hitSoundsInRange, notes);
                ...
                Parallel.ForEach(keysInRange, key =>
                     {
                         ...
                         double speedMultiplier = instance.findSV(note.starttime);
                         easetime = scrollSpeed / speedMultiplier;
                         ...
                         do
                         {
                             ...
                             speedMultiplier = instance.findSV(currentTime);

                             easetime = scrollSpeed / speedMultiplier;

                             debug += $"{currentTime}, {speedMultiplier}\n";
                         ...
                         Parallel.ForEach(note.sliderPositions, part =>
                              {
                                  ...
                                  if (playfieldInstance.isColored)
                                      sprite.Color(currentTime - 1, instance.color);
                                  ...
                                  do
                                  {
                                      ...
                                      speedMultiplier = instance.findSV(sliderCurrentTime);
